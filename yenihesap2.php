...
if($_POST)
{
$result = $_POST['secimimx'];
$result_explode = explode('|', $result);  
$en=$_POST["enx"];
$boy=$_POST["boyx"];
$yukseklik=$_POST["yukseklikx"];
$agirlik=$_POST["agirlikx"];
    ...
    echo 'Connection Faild: '.$con->connect_error;
         ...
         if($bug>$agirlik){
            ...
            while($row=$res->fetch_assoc()){
                ...
                echo "<b>UPS FİYAT: </b>".$row["$result_explode[0]"] ." € <br /> "; 
                echo "<img src=cargo2.png>";
                echo "<b>FEDEX FİYAT:</b>".$row["$result_explode[1]"] ." €<br /><br><br><br>"; 
            ...
            while($row=$res->fetch_assoc()){
                ...
                echo "<img src=cargo2.png>";
                echo "<b>FEDEX FİYAT:</b>".$row["$result_explode[1]"]." €<br /><br><br><br>"; 
                echo '<a href="yenihesap.php">GERİ</a>';  
                }  }   
        }
}
?>
