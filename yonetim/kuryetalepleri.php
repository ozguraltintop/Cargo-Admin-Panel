...
$kuryeler = $db->query("select * from kuryenot");
...
<tr style="border:1px solid green;">
    ...
    <td style="color:green;border:1px solid green;padding:15px;">Kimden Talep Geldi</td>
    <td style="color:green;border:1px solid green;padding:15px;">Kurye Talep Notu</td>
...
<?php 
    ...
    foreach($kuryeler as $kuryex)
    {
        echo "<tr> <td>".$kuryex["kimden"]."</td>  
        <td>".$kuryex["notx"]."</td>";
        
        
        echo "<td><a href='kuryesil.php?id=".$kuryex["id"]."'>Sil</a></td>";
