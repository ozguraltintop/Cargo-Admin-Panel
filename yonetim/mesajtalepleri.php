...
$mesajlar = $db->query("select * from mesajlar");
...
<tr style="border:1px solid green;">
    ...
    <td style="color:green;border:1px solid green;padding:15px;">Kimden Mesaj Geldi</td>
    <td style="color:green;border:1px solid green;padding:15px;">Mesaj</td>
    <td style="color:green; border:1px solid green;padding:15px;">SİL</td>
   
</tr>

<?php 

    foreach($mesajlar as $mesajx)
    {
        echo "<tr> <td>".$mesajx["kimden"]."</td>  
        <td>".$mesajx["mesajim"]."</td>";
        
        
        echo "<td><a href='mesajsil.php?id=".$mesajx["id"]."'>Sil</a></td>";
